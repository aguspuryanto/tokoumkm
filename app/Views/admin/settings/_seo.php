    ...
    <div class="card-body">
        <form action="/pengaturan/store" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="google_analytics" name="google_analytics" required>
            </div>
            <div class="form-group">
                <label for="description">Google Search Console</label>
                <textarea class="form-control" id="google_search_console" name="google_search_console" required></textarea>
            </div>
